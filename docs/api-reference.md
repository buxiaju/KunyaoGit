...
>
> 适用版本：**v0.6.0**（v0.2.3+ 主题与语言、v0.2.4+ 下载速度优化、v0.2.5+ 三主题切换、v0.2.6+ 探活修复、v0.3.0+ 文件管理/多远程推送、v0.3.1+/v0.3.3+ 更新下载修复、v0.3.4+ 云端搜索、v0.4+ 命令面板/快捷键/Stash 队列/Cherry-pick/Revert/PR 创建/状态栏、v0.5+ Ctrl+P 跳转文件/文件历史+Blame、**v0.6+ Release 附件管理/编辑/Markdown 渲染**）
>
> 源码依据：
